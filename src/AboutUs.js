        ...
        <div className="hero-head">
          <div className="container has-text-centered">
            <div className="title is-2 heading level-item">
              <div className="has-text-centered">About Us</div>
            </div>
          </div>
        </div>
            ...
            <div className="columns is-vcentered">
              ...
              <div className="column">
                ...
                <div className="font subtitle is-4 has-text-justified">
                  ...
                  past few decades in this region. With sweet memory of
                  foundation ceremony by our Hon'ble President Dr. Rajendra
                  Prasad on 14th September 1956, the institute started with two
                  departments namely Metallurgical and Mining Engineering. Later
                  the inauguration of the Institute building was done by our
                  Hon'ble Prime Minister Pt. Jawahar Lal Nehru on 14th March
                  1963. From 1st December 2005, the institute has become the
                  National Institute of Technology. Presently, the institute
                  offers 12 undergraduate and 6 postgraduate courses & almost
            ...
            <div className="columns is-vcentered">
              <div className="column">
                ...
                <div className="font subtitle is-4 has-text-justified">
                  ...
                  one of the largest departments of the institute with intake of
                  90 students for undergraduate course and 43 students for post
                  graduate course. Department also offers Ph.D. program in all
                  relevant discipline of Mechanical Engineering including
                  Thermal, Design, Production, and Industrial Engineering and
                  Management.
                </div>
              </div>
              <div className="column has-text-right">
            ...
            <div className="columns is-vcentered">
              ...
              <div className="column">
                ...
                <div className="font subtitle is-4 has-text-justified">
                  ...
                  some of the interesting places to visit in Raipur. Raipur is a
                  fast-developing city and emerging as education hub of India.
                  Many institutions like National Law University, AIIMS, IIM,
                  Engineering and Medical College have been established here.
                  Since, Chhattisgarh is rich in mineral, agriculture and
